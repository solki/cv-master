/** Simple inline SVG icons for CV Master. 20x20, currentColor. */
...
export function ProjectsIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="10" y="3" width="12" height="4" rx="0.5" />
      <rect x="2" y="10" width="6" height="4" rx="0.5" />
      <rect x="10" y="10" width="12" height="4" rx="0.5" />
      <rect x="2" y="17" width="6" height="4" rx="0.5" />
      <rect x="10" y="17" width="12" height="4" rx="0.5" />
    </svg>
  );
}
...
export function JDIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
